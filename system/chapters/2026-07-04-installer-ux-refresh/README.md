...
**Status:** In progress — opened 2026-07-04 (System Track). Slice 1 (freshness + first-run UX) built; slice 2 (lifecycle correctness) in flight. This header is updated as slices land.
...
*(Slice 2 outcomes appended when it lands.)*
